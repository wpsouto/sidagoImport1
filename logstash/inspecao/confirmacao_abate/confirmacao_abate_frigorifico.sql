...
FROM   gta.gta AS gt
       ...
       INNER JOIN gta.gta_destino AS gtd ON gt.id_gta = gtd.id_gta AND gtd.tp_destino = 'frigorifico'
       INNER JOIN agrocomum.inscricaoestadual AS ied ON ied.id_inscricaoestadual = gtd.id_destino
       ...
       INNER JOIN dne.log_localidade AS ld ON gtd.id_municipio = ld.loc_nu AND ld.ufe_sg = 'GO'
