SELECT s.id_saldo                                            AS id,
       ...
       pro.nu_codigoanimal                                   AS propriedade_codigo,
       ie.ts_inscricaoestadual                               AS propriedade_cadastro,
       EXTRACT(YEAR FROM ie.ts_inscricaoestadual)            AS propriedade_cadastro_ano,
